...
IF "%response%"=="X" (
    ...
    IF "%opponent%" == "B" SET /A score=score+0
    IF "%opponent%" == "C" SET /A score=score+6
)
IF "%response%"=="Y" (
    SET /A score=score+2
    IF "%opponent%" == "A" SET /A score=score+6
    IF "%opponent%" == "B" SET /A score=score+3
    IF "%opponent%" == "C" SET /A score=score+0
)
IF "%response%"=="Z" (
    SET /A score=score+3
    IF "%opponent%" == "A" SET /A score=score+0
    IF "%opponent%" == "B" SET /A score=score+6
